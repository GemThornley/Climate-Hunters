...
Original file is located at
    https://colab.research.google.com/drive/1fdVEsZX8s5p5tXx4WRaiehZGCtrhRqcM
"""
...
fig = px.choropleth_mapbox(df, locations='id', geojson=uk_con, 
                           color='green_voter %', hover_name="name", 
...
pio.write_html(fig, file='GREEN MAP.html', auto_open=True)