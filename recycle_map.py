...
fig = px.choropleth_mapbox(df, locations='id', geojson=uk_con, color='recycling %', hover_name="name", mapbox_style="carto-positron", zoom=4, center = {"lat": 55, "lon": 0})
...
tls.get_embed('https://rusheenb.github.io/ilovemaps/') #change to your url